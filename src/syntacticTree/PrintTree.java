...
public class PrintTree {
    ...
    public String printRoot(ListNode x) {
    	if (x == null) {
            System.out.println("Árvore sintática vazia. Nada a ser exibido.");
        } else {
    ...
    public void printClassDeclListNode(ListNode x) {
        ...
        System.out.println();
        String no = x.number + ": ListNode (ClassDeclNode)  ===> " +
                x.node.number + " " +
    ...
    public void printClassDeclNode(ClassDeclNode x) {
        ...
        System.out.println();
        String no = x.number + ": ClassDeclNode ===> " + x.name.image +
    ...
    public void printClassBodyNode(ClassBodyNode x) {
        ...
        System.out.println();
        String no = x.number + ": ClassBodyNode ===> " +
    ...
    // ---------------- Lista de declaracães de variáveis ---------------- 
    ...
    public void printVarDeclListNode(ListNode x) {
        ...
        System.out.println();
        String no = x.number + ": ListNode (VarDeclNode) ===> " +
                x.node.number + " " +
                ((x.next == null) ? "null" : String.valueOf(x.next.number));
        System.out.print(no);
    ...
    public void printVarDeclNode(VarDeclNode x) {
        ...
        System.out.println();
        String no = x.number + ": VarDeclNode ===> " + x.position.image +
                " " + x.vars.number;
        System.out.print(no);
    ...
    public void printvarListNode(ListNode x) {
        ...
        System.out.println();
        String no = x.number + ": ListNode (VarNode) ===> " +
                x.node.number + " " +
                ((x.next == null) ? "null" : String.valueOf(x.next.number));
        System.out.print(no);
    ...
    public void printConstructDeclListNode(ListNode x) {
        ...
        System.out.println();
        String no = x.number + ": ListNode (ConstructDeclNode) ===> " +
                x.node.number + " " +
                ((x.next == null) ? "null" : String.valueOf(x.next.number));
        System.out.print(no);
        sb.append(no).append("\n");
    ...
    public void printConstructDeclNode(ConstructDeclNode x) {
        ...
        System.out.println();
        String no = x.number + ": ConstructDeclNode ===> " +
                x.body.number;
        System.out.print(no);
    ...
    public void printMethodDeclListNode(ListNode x) {
        ...
        System.out.println();
        String no = x.number + ": ListNode (MethodDeclNode) ===> " +
                x.node.number + " " +
                ((x.next == null) ? "null" : String.valueOf(x.next.number));
        System.out.print(no);
    ...
    public void printMethodDeclNode(MethodDeclNode x) {
        ...
        System.out.println();
        String no = x.number + ": MethodDeclNode ===> " +
    ...
    public void printMethodBodyNode(MethodBodyNode x) {
        ...
        System.out.println();
        String no = x.number + ": MethodBodyNode ===> " +
    ...
    public void printBlockNode(BlockNode x) {
        ...
        System.out.println();
        String no = x.number + ": BlockNode ===> " + x.stats.number;
        System.out.print(no);
    ...
    public void printStatementListNode(ListNode x) {
        ...
        System.out.println();
        String no = x.number + ": ListNode (StatementNode) ===> " +
                x.node.number + " " +
                ((x.next == null) ? "null" : String.valueOf(x.next.number));
        System.out.print(no);
    ...
    public void printPrintNode(PrintNode x) {
        ...
        System.out.println();
        String no = x.number + ": PrintNode ===> " + x.expr.number;
        System.out.print(no);
    ...
    public void printReadNode(ReadNode x) {
        ...
        System.out.println();
        String no = x.number + ": ReadNode ===> " + x.expr.number;
        System.out.print(no);
    ...
    public void printAtribNode(AtribNode x) {
        ...
        System.out.println();
        String no = x.number + ": AtribNode ===> " + x.expr1.number + " " +
                x.expr2.number;
        System.out.print(no);
    ...
    public void printIfNode(IfNode x) {
        ...
        System.out.println();
        String no = x.number + ": IfNode ===> " + x.expr.number + " " +
                x.stat1.number + " " +
    ...
    public void printNewObjectNode(NewObjectNode x) {
        ...
        System.out.println();
        String no = x.number + ": NewObjectNode ===> " + x.name.image +
                " " + ((x.args == null) ? "null" : String.valueOf(x.args.number));
        System.out.print(no);
    ...
    public void printNewArrayNode(NewArrayNode x) {
        ...
        System.out.println();
        String no = x.number + ": NewArrayNode ===> " + x.name.image +
    ...
    public void printExpreListNode(ListNode x) {
        ...
        System.out.println();
        String no = x.number + ": ListNode (ExpreNode) ===> " +
                x.node.number + " " +
                ((x.next == null) ? "null" : String.valueOf(x.next.number));
        System.out.print(no);
    ...
    public void printRelationalNode(RelationalNode x) {
        ...
        System.out.println();
        String no = x.number + ": RelationalNode ===> " + x.expr1.number +
    ...
    public void printAddNode(AddNode x) {
        ...
        System.out.println();
        String no = x.number + ": AddNode ===> " + x.expr1.number + " " +
                x.position.image + " " + x.expr2.number;
        System.out.print(no);
    ...
    public void printMultNode(MultNode x) {
        ...
        System.out.println();
        String no = x.number + ": MultNode ===> " + x.expr1.number + " " +
                x.position.image + " " + x.expr2.number;
        System.out.print(no);
    ...
    public void printUnaryNode(UnaryNode x) {
        ...
        System.out.println();
        String no = x.number + ": UnaryNode ===> " + x.position.image +
                " " + x.expr.number;
        System.out.print(no);
    ...
    public void printIntConstNode(IntConstNode x) {
        ...
        System.out.println();
        String no = x.number + ": IntConstNode ===> " + x.position.image;
        System.out.print(no);
    ...
    public void printStringConstNode(StringConstNode x) {
        ...
        System.out.println();
        String no = x.number + ": StringConstNode ===> " +
                x.position.image;
        System.out.print(no);
    ...
    public void printNullConstNode(NullConstNode x) {
        ...
        System.out.println();
        String no = x.number + ": NullConstNode ===> " + x.position.image;
        System.out.print(no);
    ...
    public void printVarNode(VarNode x) {
        ...
        System.out.println();
        String no = x.number + ": VarNode ===> " + x.position.image + " " +
                ((x.dim == 0) ? "" : ("[" + x.dim + "]"));
        System.out.print(no);
    ...
    public void printCallNode(CallNode x) {
        ...
        System.out.println();
        String no = x.number + ": CallNode ===> " + x.expr.number + " " +
                x.meth.image + " " +
                ((x.args == null) ? "null" : String.valueOf(x.args.number));
        System.out.print(no);
    ...
    public void printIndexNode(IndexNode x) {
        ...
        System.out.println();
        String no = x.number + ": IndexNode ===> " + x.expr1.number + " " +
                x.expr2.number;
        System.out.print(no);
    ...
    public void printDotNode(DotNode x) {
        ...
        System.out.println();
        String no = x.number + ": DotNode ===> " + x.expr.number + " " +
                x.field.image;
        System.out.print(no);
