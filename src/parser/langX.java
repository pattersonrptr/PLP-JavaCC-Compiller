...
import codegen.*;       // importa as classes para geração de código
...
// Define o método "main" da classe langX.  
  public  static void main(String args[]) throws ParseException
  {
    ...
    {
        if (args[i].equals("-debug_AS") )                       // Liga o debug do AS
            debug_as = true;
        else
        if (args[i].equals("-debug_recovery") )         // Liga o debug da recuperação de erros
            debug_recovery = true;
        else
        if (args[i].equals("-print_tree") )                     // Exibe a árvore sintática (em texto)
            print_tree = true;
        else
        {                                                                                       // Se passado parâmetros errados, exibe mensagem de ajuda
          ...
          + parser.contParseError == 0)                 // A árvore sintática
    {
        ...
        // Gera o código .jas
        try {
             tc.CodeGenRoot(root, filename);    // Recebe o nó/token root da árvore e o nome do arquivo
...
// Relaciona um token reconhecido com o seu nome.
static public String im(int x)
{
        int k;
        String s;
        s = tokenImage[x];              // Exemplo: "\"class\""
        k = s.lastIndexOf("\u005c"");
        try {
          s = s.substring(1, k);// Exemplo: "class"
        }
...
// O método abaixo consome tokens até alcançar um que pertença ao conjunto de sincronização
...
Token tok;
   ...
   if ( debug_recovery) // informação sobre a recuperação
   {
       ...
       System.out.println("     Sincronizando Conjunto de Recupera\u00e7\u00e3o: " + g);
   }
   ...
   if ( eof ) throw new ParseEOFException("EOF encontrado prematuramente");
}
...
// Corpo da classe (tudo o que pode ter dentro de uma classe)
